...
const borderClasses = {
    ...
    primary: 'border-primary-500 darke:border-primary-400'
};
const ringClasses = {
...
const colorClasses = {
    ...
    primary: 'bg-primary-50 text-primary-900 placeholder-primary-700 dark:tprimary-red-500 dark:placeholder-primary-500 dark:bg-gprimary-700'
};
